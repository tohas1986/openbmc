...
#FILES:{PN} = "${sbindir}/cpudimm_temp_sensor"
#DBUS_SERVICE_${PN} = "xyz.openbmc_project.Ipmi.Ipmb.cpudimm.temp.service"

SYSTEMD_SERVICE:${PN} = "xyz.openbmc_project.Ipmi.Ipmb.cpudimm.temp.service"
SYSTEMD_SERVICE:${PN} += "xyz.openbmc_project.Hwmon-cpudimmtemp.service"
